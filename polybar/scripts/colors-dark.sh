...
# Replacing colors
sed -i -e 's/shade1 = .*/shade1 = #007fff/g' $PDIR/config.ini
sed -i -e 's/shade2 = .*/shade2 = #00ff7f/g' $PDIR/config.ini
sed -i -e 's/shade3 = .*/shade3 = #7fff00/g' $PDIR/config.ini
sed -i -e 's/shade4 = .*/shade4 = #ff7f00/g' $PDIR/config.ini
sed -i -e 's/shade5 = .*/shade5 = #ff007f/g' $PDIR/config.ini
sed -i -e 's/shade6 = .*/shade6 = #7f00ff/g' $PDIR/config.ini
sed -i -e 's/shade7 = .*/shade7 = #7f007f/g' $PDIR/config.ini
sed -i -e 's/shade8 = .*/shade8 = #007f7f/g' $PDIR/config.ini
sed -i -e 's/accent = .*/accent = #f7f7f7/g' $PDIR/config.ini
sed -i -e 's/bground = .*/bground = #1D1F28/g' $PDIR/config.ini
sed -i -e 's/modulefg-alt = .*/modulefg-alt = #f7f7f7/g' $PDIR/config.ini
# Restarting polybar
$LAUNCH &

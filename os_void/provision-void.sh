...
# CLI Software I like
sudo xbps-install zsh vim vim-common vim-colorschemes sakura kitty lynx emacs emacs-common rclone nmap exa rofi dunst picom tmux xdgmenumaker polybar pastel
